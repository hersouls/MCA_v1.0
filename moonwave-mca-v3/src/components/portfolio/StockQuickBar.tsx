            ...
            return (
              <button
                ...
                className={clsx(
                  ...
                  isSaved
                    ? 'bg-surface-hover border-border opacity-60 cursor-default'
                    : 'bg-card border-border hover:border-primary-300 hover:shadow-md hover:-translate-y-0.5 dark:hover:border-primary-700'
                )}
              >
                {/* Logo */}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span className="px-1.5 py-0.5 rounded bg-surface-hover">
                      {stock.market}
                    </span>
                  </div>
                </div>
