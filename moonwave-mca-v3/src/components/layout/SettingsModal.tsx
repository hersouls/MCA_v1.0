...
type SettingsTab = 'appearance' | 'data' | 'notifications';

const tabs: { id: SettingsTab; label: string; icon: React.ReactNode }[] = [
  { id: 'appearance', label: TEXTS.SETTINGS.TAB_APPEARANCE, icon: <Palette className="w-4 h-4" /> },
  { id: 'data', label: TEXTS.SETTINGS.TAB_DATA, icon: <Database className="w-4 h-4" /> },
  { id: 'notifications', label: TEXTS.SETTINGS.TAB_NOTIFICATIONS, icon: <Bell className="w-4 h-4" /> },
];
            ...
            {activeTab === 'appearance' && (
              <>
                ...
                <div>
                  ...
                  {/* Live Preview (6-2) */}
                  <div className="mt-3 p-3 rounded-lg border border-border bg-surface-hover">
                    <p className="text-[10px] font-medium text-muted-foreground mb-2 uppercase tracking-wider">미리보기</p>
                    <div className="flex items-center gap-2">
                      <div className="px-3 py-1.5 rounded-lg bg-primary-500 text-white text-xs font-medium">
                        버튼
                      </div>
                      <div className="px-2 py-1 rounded-md bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 text-xs font-medium">
                        뱃지
                      </div>
